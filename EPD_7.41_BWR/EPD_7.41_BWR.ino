/* 
 *  This example code is for 7.4" Spectra EPD of Pervasive Displays Inc (PDi) on EXT2 board which is verified by TI LaunchPad EK-TM4C123GXL.
...
#include "image_data\image_740_800x480_BW.c"
#include "image_data\image_740_800x480_BWR.c"
...
void sendImageData(uint8_t * blackBuffer, uint8_t * redBuffer)
{
    ...
    _sendIndexData(0x10, blackBuffer, 48000); // First frame

    // uint8_t data3[] = {0x3b, 0x00, 0x14}; // RAM_RW
    _sendIndexData(0x12, data3, 3); // RAM_RW

    Serial.print("2nd frame... ");
    _sendIndexData(0x11, redBuffer, 48000); // Second frame
